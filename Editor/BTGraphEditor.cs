...
namespace Saro.BT.Designer
{
     ...
     * x. 节点编辑面板，节点详情
     * 3. 撤销/重做
     * x. 快速连线，使用 IEdgeConnectorListener
     * x. playmode禁止编辑，node节点错乱修正
     * 6. 新增分组，分组保存在 TreeAsset 里
     * 
     */
    ...
    public sealed class BTGraphEditor : EditorWindow
    {
        ...
        {
            // TODO 进playmode时，会报空！但切回编辑模式，没有报空
            // OnPlayModeStateChanged / Selection.selectionChanged 都会报空
