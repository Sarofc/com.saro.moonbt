...
#pragma warning disable 618 // deprecation
    ...
    public class BlackboardTest
    {
        ...
        public void ShouldListenToEvents_WhenUsingChildBlackboard()
        {
            ...
            BlackboardCondition firstCondition = new BlackboardCondition("branch1", Operator.IS_EQUAL, true, ObserverAborts.BOTH, firstChild);
            BlackboardCondition secondCondition = new BlackboardCondition("branch2", Operator.IS_EQUAL, true, ObserverAborts.BOTH, secondChild);
